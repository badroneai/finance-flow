...
export const Icons = {
  ...
  empty: (p) => <svg {...{ width: p?.size || 64, height: p?.size || 64, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", className: p?.className || 'text-[var(--color-muted)]' }}><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" /><line x1="9" y1="13" x2="15" y2="13" /></svg>,
  ...
  pulse: (p) => <svg {...{ width: p?.size || 20, height: p?.size || 20, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: p?.className || '' }}><path d="M22 12h-4l-3 9L9 3l-3 9H2" /></svg>,
  inbox: (p) => <svg {...{ width: p?.size || 20, height: p?.size || 20, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: p?.className || '' }}><path d="M22 12h-6l-2 3H10L8 12H2" /><path d="M5.45 5.11L2 12v6a2 2 0 002 2h16a2 2 0 002-2v-6l-3.45-6.89A2 2 0 0016.76 4H7.24a2 2 0 00-1.79 1.11z" /></svg>,
  ledgers: (p) => <svg {...{ width: p?.size || 20, height: p?.size || 20, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: p?.className || '' }}><path d="M4 19.5A2.5 2.5 0 016.5 17H20" /><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v-15A2.5 2.5 0 016.5 2z" /><line x1="8" y1="6" x2="16" y2="6" /><line x1="8" y1="10" x2="16" y2="10" /></svg>,
  transactions: (p) => <svg {...{ width: p?.size || 20, height: p?.size || 20, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: p?.className || '' }}><line x1="7" y1="17" x2="17" y2="7" /><polyline points="7 7 17 7 17 17" /></svg>,
  report: (p) => <svg {...{ width: p?.size || 20, height: p?.size || 20, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: p?.className || '' }}><line x1="18" y1="20" x2="18" y2="10" /><line x1="12" y1="20" x2="12" y2="4" /><line x1="6" y1="20" x2="6" y2="14" /></svg>,
  moreMenu: (p) => <svg {...{ width: p?.size || 20, height: p?.size || 20, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: p?.className || '' }}><circle cx="12" cy="5" r="1" fill="currentColor" /><circle cx="12" cy="12" r="1" fill="currentColor" /><circle cx="12" cy="19" r="1" fill="currentColor" /></svg>,
  commissions: (p) => <svg {...{ width: p?.size || 20, height: p?.size || 20, viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", className: p?.className || '' }}><circle cx="12" cy="12" r="10" /><path d="M16 8h-6a2 2 0 100 4h4a2 2 0 110 4H8" strokeLinecap="round" /><line x1="12" y1="6" x2="12" y2="8" /><line x1="12" y1="16" x2="12" y2="18" /></svg>,
};
...
export const FormField = ({ label, error, children, id: fieldId }) => {
  ...
  return (
    <div className="mb-3">
      {fieldId ? <label className="block text-sm font-medium text-[var(--color-text)] mb-1" htmlFor={fieldId}>{label}</label> : <label className="block text-sm font-medium text-[var(--color-text)] mb-1">{label}</label>}
      {enhancedChild}
...
export const Badge = ({ children, color = 'blue' }) => {
  const colors = { blue: 'bg-blue-50 text-blue-700', green: 'bg-green-50 text-green-700', red: 'bg-red-50 text-red-700', yellow: 'bg-yellow-50 text-yellow-700', gray: 'bg-[var(--color-bg)] text-[var(--color-muted)]' };
